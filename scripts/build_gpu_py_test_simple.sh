...
# gpu
cmake .. -DGENERATOR=Ninja -DCMAKE_VERBOSE_MAKEFILE:BOOL=OFF -DPY_VERSION=${PYVER} -DWITH_GPU=ON -DWITH_TESTING=ON -DCMAKE_BUILD_TYPE=Release -DWITH_CUSTOM_DEVICE=ON -DWITH_MKL=ON -DWITH_MKLDNN=ON -DCMAKE_EXPORT_COMPILE_COMMANDS=ON
